...
$sqluser = "root";
$sqlpassword = "bll.raslen";
$sqldatabase = "uni_library";
...
<div>
    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        ...
        echo '<br>Name<br><input type="text" name="fname"  placeholder="First Name"><br>';
        ...
        echo '<br>E-mail<br><input type="text" name="email"  placeholder="email@example.com"><br>';
